...
def update_ticker(params,datestamp):


    print(datestamp)

    if params["ticker"] == "TSLA":
        diego = 1
    ...
    if LIVE:
        ...
        print(params["ticker"])
        print("Last: "+str(params["last"])+" change: "+str(params["change"]))
        ...
        with SSHTunnelForwarder(
            ...
            print(params["ticker"])
            print(params["FiftyTwoWeekChange"])
        ...
        try:
            if stock_object != None:
                ...
                if stock_previous_close != 0:
                    ...
                    change = (params["last"] - params["open"]) / params["open"]
                ...
                update_ticker(params,datestamp)
