  ...
  My Stock News App<br/>All you need on a daily basis
			...
			<tr>
                <td style="padding:10px 10px 0px 10px">
                    <table style="width: 100%;  background-color: #fff;margin-top:20px ">
                        <tr>
                        <td style="color:#0015AC;font-weight:bold;font-family:Gilroy-Bold,Helvetica; text-align:center; font-size: 30px;">New User</td>
            ...
            <tr>
                <td style="padding:10px 10px 0px 10px">
                    <table style="width: 100%;  background-color: #fff;margin-top:20px ">
                        <tr>
                            <th style="color:#000;font-weight:bold;font-family:Gilroy-Bold,Helvetica; text-align:right; font-size: 20px;">First Name:</th>
                            <td style="color:#000;font-family:Gilroy-Light,Helvetica; text-align:left; font-size: 20px; ">
                                {{$user->first_name}}
                            </td>
                        </tr>
                        <tr>
                            <th style="color:#000;font-weight:bold;font-family:Gilroy-Bold,Helvetica; text-align:right; font-size: 20px; ">Last Name:</th>
                            <td style="color:#000;font-family:Gilroy-Light,Helvetica; text-align:left; font-size: 20px; ">
                                {{$user->last_name}}
                            </td>
                        </tr>
                        <tr>
                            <th style="color:#000;font-weight:bold;font-family:Gilroy-Bold,Helvetica; text-align:right; font-size: 20px; ">Email:</th>
                            <td style="color:#000;font-family:Gilroy-Light,Helvetica; text-align:left; font-size: 20px; ">
                                {{$user->email}}
                            </td>
                        </tr>
                        <tr>
                            <th style="color:#000;font-weight:bold;font-family:Gilroy-Bold,Helvetica; text-align:right; font-size: 20px; "></th>
                            <td style="color:#000;font-family:Gilroy-Light,Helvetica; text-align:left; font-size: 20px; ">
                                {{$time}}
                            </td>
                        </tr>
